    ...
    <div x-data="{
        ...
        <div x-show="open" x-transition class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" x-cloak>
            <form
                ...
                method="POST" class="bg-gray-100 p-6 rounded-lg w-full max-w-4xl relative">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label>Ruangan</label>
                        <input type="text" class="w-full bg-gray-300 p-2 rounded" x-model="selectedItem.ruangan" disabled>
                    </div>
                    <div>
